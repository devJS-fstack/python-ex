...
button_style = {"padx": 10, "pady": 10, "width": 200,
                "font": ("Helvetica", 12), "background": "yellow"}


open_speech_to_text_button = tkmacosx.Button(
...
open_image_processing_button = tkmacosx.Button(
...
open_frame_cutter_button = tkmacosx.Button(
...
open_image_comparison = tkmacosx.Button(
